...
<div class="wrapper">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <!-- Optionally, you can add icons to the links -->
			...
			<li class="active"><a href="#"><i class="fa fa-wrench"></i> <span>HARDWARE</span></a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1> HARDWARE &nbsp; &nbsp; &nbsp; &nbsp; <small>Coming Soon</small></h1>
      <ol class="breadcrumb">
      	...
      	<div class="row">
			<div class="box">
				<div class="box-header with-border">
				  <h3 class="box-title"><em class="fa fa-plus"></em> Installed Hardware</h3>
				</div>
				<div class="box-body bg-gray">
					<div class="col-md-3 col-sm-6 col-xs-12">
					  <a href="#"><div class="info-box">
						<span class="info-box-icon bg-purple-gradient"><i class="fa fa-tv"></i></span>

						<div class="info-box-content">
							<span class="info-box-number">LCD Screen</span>
					...
					<div class="col-md-3 col-sm-6 col-xs-12">
					  <a href="#"><div class="info-box">
						<span class="info-box-icon bg-red-gradient"><i class="fa fa-wifi"></i></span>

						<div class="info-box-content">
							<span class="info-box-number">Wireless Adapter</span>
							<span class="info-box-text">STATUS: <strong>INSTALLED</strong></span>
						</div>
						 </div></a>
					</div>
